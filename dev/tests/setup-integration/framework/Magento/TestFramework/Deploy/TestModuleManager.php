...
class TestModuleManager
{
     ...
     */
    const DECLARATIVE_FILE_NAME = "elogic_storelocator_store_list_form.xml";
     ...
     * @param string $revisionName Folder name, like reviisions/revision_1/elogic_storelocator_store_list_form.xml
     * @param string $fileName     For example elogic_storelocator_store_list_form.xml
