...
class SafeInstallerTest extends SetupTestCase
{
    ...
    public function testInstallation()
    {
        ...
        //Move new elogic_storelocator_store_list_form.xml
        $this->moduleManager->updateRevision(
            'Magento_TestSetupDeclarationModule4',
            'remove_title_column',
            'elogic_storelocator_store_list_form.xml',
            'etc'
        );
        ...
        //Move new elogic_storelocator_store_list_form.xml with restored title field
        $this->moduleManager->updateRevision(
            'Magento_TestSetupDeclarationModule4',
