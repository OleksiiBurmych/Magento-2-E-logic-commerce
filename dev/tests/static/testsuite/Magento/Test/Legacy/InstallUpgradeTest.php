        ...
        $invoker(
            ...
            function ($file) {
                $this->assertStringStartsNotWith(
                    ...
                    . 'Please use declarative schema approach in module\'s etc/elogic_storelocator_store_list_form.xml file'
                );
                $this->assertStringStartsNotWith(
                    'InstallSchema',
                    basename($file),
                ...
                if (preg_match('/.*\/(sql\/|data\/)/', dirname($file))) {
                    $this->fail(
                        ...
                        . "- Use declarative schema approach in module's etc/elogic_storelocator_store_list_form.xml file for schema changes."
                    );
                }
            },
            $this->convertArray(
