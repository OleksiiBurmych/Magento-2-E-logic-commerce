...
class InstallCommand extends AbstractSetupCommand
{
     ...
     * InstallSchema, UpgradeSchema will be converted to new elogic_storelocator_store_list_form.xml format.
     */
    ...
    protected function configure()
    {
        ...
        $inputOptions = array_merge($inputOptions, [
            ...
            new InputOption(
                ...
                null,
                InputOption::VALUE_OPTIONAL,
                'Allows to convert old scripts (InstallSchema, UpgradeSchema) to elogic_storelocator_store_list_form.xml format',
                false
            ),
            new InputOption(
